...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" type="text/css" href="Diseño/fontello.css">
    <link rel="stylesheet" type="text/css" href="Diseño/estilos.css">
    <link rel="stylesheet" type="text/css" href="Diseño/registro.css">
...
<body>
    <header>
        <div class="contenedor">
            <h1 class="icon-gamepad">AUSGaming</h1>
